...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
  ...
  if (scroll >= 50) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".navbar").addClass("sticky-nav");
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".navbar").removeClass("sticky-nav");
  }
});
...
function myFunction(x) {
  ...
  if (x.matches) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".nav-link").click(function () {
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#navbarSupportedContent').hasClass('show')) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#navbarSupportedContent').removeClass('show');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navbar-toggler').removeClass('active');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass("overflow-hidden");
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#navbarSupportedContent').removeClass('show');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navbar-toggler').addClass('active');
...
function scrollNav() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navbar .nav-link').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').stop().animate({
      scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href')).offset().top - 120
    }, 700);
    return false;
  });
}
...
;
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.yoga-carousel').slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  dots: false,
  infinite: true,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkunlimited_wp"] = self["webpackChunkunlimited_wp"] || [];
